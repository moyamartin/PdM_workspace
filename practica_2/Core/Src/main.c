...
{
  /// chequeamos que el puntero a delay sea valido
...
bool_t delayRead(delay_t *delay)
{
  ...
  if(delay->running) {
    /// si esta corriendo, verificar que supero la duracion
...
delay_t delay;
uint8_t contador_semiperiodo;
uint16_t retrasos[3] = {1000, 200, 100};
/* USER CODE END 0 */
